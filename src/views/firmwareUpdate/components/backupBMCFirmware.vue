    ...
    <el-row>
      <div class="infoBox">
        <div class="infoBoxHeader">
          <span>{{ $t('firmwareUpdate.BackupBMCTitle') }}</span>
        </div>
        <div>
          <div class="stepStyle">
          ...
          <div class="editor-container">
            <div v-if="activeStep !== 3">
              ...
              >
                ...
                <div v-if="activeStep === 0" slot="tip" class="el-upload__tip">{{ $t('firmwareUpdate.BMCUploadTip') }}</div>
              </el-upload>
...
export default {
  ...
  methods: {
    handleChange(file, fileList) {
      ...
      const fileName = file.name.slice(-4)
      this.uploadStatus = file.status
      if (fileName !== '.tar' || fileSize > 64) {
        this.$message.error(this.$t('firmwareUpdate.BMCUploadTip'))
        this.fileType = false
        this.fileList = []
        return
      } else {
