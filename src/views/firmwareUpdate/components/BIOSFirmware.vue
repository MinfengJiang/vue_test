    ...
    <el-row>
      <div class="infoBox">
        <div class="infoBoxHeader">
          <span>{{ $t('firmwareUpdate.BIOSTitle') }}</span>
        </div>
        <div>
          <div class="stepStyle">
          ...
          <div class="editor-container">
            <div v-if="activeStep !== 3">
              ...
              >
                ...
                <div v-if="activeStep === 0" slot="tip" class="el-upload__tip">{{ $t('firmwareUpdate.BIOSUploadTip') }}</div>
              </el-upload>
...
export default {
  ...
  methods: {
    handleChange(file, fileList) {
      ...
      if (fileName !== '.bin' || fileSize > 8) {
        this.$message.error(this.$t('firmwareUpdate.BIOSUploadTip'))
        this.fileType = false
        this.fileList = []
        return
      } else {
