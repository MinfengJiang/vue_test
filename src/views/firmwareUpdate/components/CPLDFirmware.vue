    ...
    <el-row>
      <div class="infoBox">
        <div class="infoBoxHeader">
          <span>{{ $t('firmwareUpdate.CPLDTitle') }}</span>
        </div>
        <div>
          <div class="stepStyle">
          ...
          <div class="editor-container">
            <div v-if="activeStep !== 3">
              ...
              >
                ...
                <div v-if="activeStep === 0" slot="tip" class="el-upload__tip">{{ $t('firmwareUpdate.CPLDUploadTip') }}</div>
              </el-upload>
...
export default {
  ...
  methods: {
    handleChange(file, fileList) {
      ...
      if (fileName !== '.aje' || fileSize > 1) {
        this.$message.error(this.$t('firmwareUpdate.CPLDUploadTip'))
        this.fileType = false
        this.fileList = []
        return
      } else {
