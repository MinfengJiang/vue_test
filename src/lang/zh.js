export default {
  ...
  security: {
    ...
    webSecurity: {
      webSecurityTitle: '网页防暴力破解',
      check: '网页防暴力开关',
      maxError: '最大连续错误次数',
      maxErrorPlaceholder: '请输入最大连续错误次数',
      lockTime: '锁定时间（秒）',
      lockTimePlaceholder: '请输入锁定时间',
      tip1: '关闭防暴力开关会降低安全等级，建议开启它',
      tip2: '防暴力破解策略将被修改，请确认是否继续设置',
      tip3: '输入参数无效，请检查输入参数。最大连续错误次数范围: 1 ~ 255',
      tip4: '输入参数无效，请检查输入参数。锁定时间范围: 1 ~ 65535',
      comfirmMsg: '此操作将修改防暴力破解策略, 是否继续?'
    }
  }
}
